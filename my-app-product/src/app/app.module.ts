...
const routes: Routes = [
  ...
  { path: '', redirectTo: 'home', pathMatch: 'full'},
  { path: 'user', loadChildren: () => import('./pages/rol-user/rol-user.module').then(m => m.RolUserModule), canActivate: [CheckLoginGuard] },
  { path: 'producto', component: FrmProductComponent, canActivate: [CheckLoginGuard] },
  { path: 'data', component: FrmDataComponent, canActivate:[CheckLoginGuard]},
  { path: 'update/:id', component: FrmUpdateComponent, canActivate:[CheckLoginGuard] },
  { path: 'emp', loadChildren: () => import('./pages/rol-emp/rol-emp.module').then(m => m.RolEmpModule), canActivate: [CheckLoginGuard] },
  { path: 'images', loadChildren: () => import('./pages/images/images.module').then(m => m.ImagesModule), canActivate: [CheckLoginGuard] },
